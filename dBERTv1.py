...
from transformers import DistilBertForSequenceClassification, DistilBertTokenizer, DistilBertModel, get_linear_schedule_with_warmup
...
def initialize_model(epochs=4):
    ...
    dbert_classifier = DistilBertClassifier(freeze_bert=False)
...
print(f'{len(data)} tweets loaded:')
print(data)
...
dbert_classifier, optimizer, scheduler = initialize_model(epochs=2)

# Specify loss function
loss_fn = nn.CrossEntropyLoss()

# Train model
train(dbert_classifier, train_dataloader, val_dataloader, epochs=2, evaluation=True)
...
out = out.replace(0,-1)
out.to_csv('out/submission_dBERTv1.csv', index=False)
