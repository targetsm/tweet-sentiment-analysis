...
from data_util import get_dataset, get_dataset_stopword, get_dataset_stopword_trans
from models import LSTMClassifier

X_train, Y_train, X_test = get_dataset_stopword_trans("fr")
...
def train_model(model):
    ...
    for epoch in range(100): 
        torch.save(model, "./log/stpwd_trans_fr/{:02d}.pt".format(epoch))
...
# model = torch.load("./log/99.pt", map_location=torch.device('cpu'))
...
with open("./word2embd.stpwd.trans.fr.twitter_lstm.csv", "w") as f:
