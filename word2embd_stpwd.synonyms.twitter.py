...
from data_util import get_dataset, get_dataset_stopword, get_dataset_stopword_synonyms
from models import LSTMClassifier

X_train, Y_train, X_test = get_dataset_stopword_synonyms()
...
def train_model(model):
    ...
    for epoch in range(100): 
        torch.save(model, "./log/stpwd_syn/{:02d}.pt".format(epoch))
...
with open("./word2embd.stpwd.syn.twitter_lstm.csv", "w") as f:
