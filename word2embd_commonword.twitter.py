...
from data_util import get_dataset, get_dataset_stopword, get_dataset_commonword
from models import LSTMClassifier

X_train, Y_train, X_test = get_dataset_commonword(5000)
...
def train_model(model):
    ...
    for epoch in range(100): 
        torch.save(model, "./log/common_word/{:02d}.pt".format(epoch))
...
model = torch.load("./log/common_word/99.pt", map_location=torch.device('cpu'))
...
with open("./word2embd.commonword.twitter_lstm.csv", "w") as f:
