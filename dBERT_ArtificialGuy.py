# Based on https://github.com/theartificialguy/NLP-with-Deep-Learning/blob/master/BERT/Amazon%20Review%20Sentiment%20Analysis/amazon_reviews_sentiment_classification.ipynb
...
for i, row in test_df.iterrows():
    ...
    with torch.no_grad():
        ...
        if output == sentiment:
            correct += 1
        #print(f'preds = ({preds[0]}, {type(preds)})')
